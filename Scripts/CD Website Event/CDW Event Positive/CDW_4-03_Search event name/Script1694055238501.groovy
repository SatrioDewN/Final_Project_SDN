...
WebUI.setText(findTestObject('Object Repository/Page_Event/Field_Search Event'), 
    'Day 4')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Event/Verify_Search_Day 4 Workshop'), 
    'Day 4: Workshop')
