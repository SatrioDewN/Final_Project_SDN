...
WebUI.click(findTestObject('Object Repository/Page_Event/Event_Day 3 Predict using Machine Learning'))

WebUI.click(findTestObject('Object Repository/Page_Day 3 Predict using Machine Learning - Ziyad/Button_Beli Tiket'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Day 3 Predict using Machine Learning - Ziyad/Verify_Add to cart Day 3 success'), 
    'add to cart success')

WebUI.click(findTestObject('Object Repository/Page_Day 3 Predict using Machine Learning - Ziyad/Button_Lihat Event Lainnya'))

WebUI.click(findTestObject('Object Repository/Page_Event/Event_Day 4 Workshop'))

WebUI.click(findTestObject('Object Repository/Page_Day 4 Workshop - Ziyad/Button_Beli Tiket'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Day 4 Workshop - Ziyad/Verify_Add to cart Day 4 success'), 'add to cart success')
