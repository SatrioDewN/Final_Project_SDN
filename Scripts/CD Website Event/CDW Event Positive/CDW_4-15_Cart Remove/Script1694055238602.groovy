...
WebUI.click(findTestObject('Object Repository/Page_Coding.ID - Cart/Remove_Cart'))

WebUI.click(findTestObject('Object Repository/Page_Coding.ID - Cart/Remove_Cart'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Coding.ID - Cart/Verify_Remove_Empty_Cart'), 
