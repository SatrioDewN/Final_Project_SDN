...
WebUI.click(findTestObject('Object Repository/Page_Day 3 Predict using Machine Learning - Ziyad/div_Harga Kelas                            _67e05a'))
...
WebUI.click(findTestObject('Object Repository/Page_Coding.ID - Cart/p_Remove'))
